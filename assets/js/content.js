...
window.CUP_STRINGS = {
  ...
  'acct.edit':     { en: 'Edit my profile', ar: 'عدّل معلوماتي' },
  'acct.emailfixed': { en: 'Your email is how you get back in, so it is not editable here.',
                       ar: 'إيميلك هو طريقك للحساب، عشان جذي ما ينعدّل من هني.' },
